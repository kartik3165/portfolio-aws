        ...
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <div className="flex items-center justify-between w-full">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <Link to="/settings" className="p-2 text-gray-400 hover:text-indigo-600 transition-colors" title="Settings">
            ...
            <main className="max-w-7xl mx-auto px-4 pb-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                    {/* Skills Card */}
                    <Link to="/skill" className="neo-card hover:border-indigo-200 group relative overflow-hidden">
                    ...
                    {/* About Card */}
                    <Link to="/about" className="neo-card hover:border-purple-200 group relative overflow-hidden">
                        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                    ...
                    {/* Blog Card */}
                    <Link to="/blog" className="neo-card hover:border-green-200 group relative overflow-hidden">
                        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                    ...
                    {/* Projects Card */}
                    <Link to="/projects" className="neo-card hover:border-blue-200 group relative overflow-hidden">
                        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {randomProjects.map(project => (
                                <Link key={project._id || project.id} to="/projects" className="neo-card flex flex-col md:flex-row gap-4 hover:shadow-lg transition-shadow">
                                    {project.coverImage && (
