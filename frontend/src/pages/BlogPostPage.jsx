...
const BlogPostPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#fafafa] font-sans text-black selection:bg-yellow-400 overflow-x-hidden">
            ...
            <main className="pt-28 pb-16 px-4 md:px-10 max-w-4xl lg:max-w-6xl mx-auto">
                <Link to="/blog" className="inline-flex items-center gap-2 font-bold mb-8 hover:underline uppercase text-sm tracking-widest">
                ...
                <article>
                    ...
                    <header className="mb-10">
                        ...
                        <h1 className="text-3xl md:text-5xl font-black uppercase leading-[1.05] mb-6">
                            {blog.title}
                        </h1>
