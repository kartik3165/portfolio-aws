...
import { Briefcase, GraduationCap, Award, BookOpen, ChevronLeft, ArrowRight, Loader2 } from 'lucide-react';
                ...
                <div className="about-header mb-16 grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
                    ...
                    <div className="about-image flex justify-center md:justify-end">
                        <div className="w-72 h-72 md:w-96 md:h-96 relative">
                            <img
                                src={bio?.about_image || "https://image.kanbs.me/blog/019c0ac5-99a8-79b1-810e-7e64cda93483.webp"}
                                alt="Kartik Nagare"
